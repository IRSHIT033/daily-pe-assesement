...
from src.repository.events import dispose_db_connection, initialize_db_connection, seed_manager_data
...
def execute_data_seed_event_handler(backend_app: fastapi.FastAPI) -> typing.Any:    
    async def seed_backend_server_events() -> None:
        await  seed_manager_data(backend_app=backend_app) 

    return seed_backend_server_events  
